...
import io.camunda.kiwi.upgrader.model.MigrateRequest;
import io.camunda.kiwi.upgrader.model.MigrateResponse;
...
public class ValuesTransformerController {
    ...
    public ResponseEntity<MigrateResponse> migratefile(@RequestPart("File") List<MultipartFile> uploadedfiles,
        ...
        String valuesToTransform = loadFileToString(uploadedfiles.get(0));
